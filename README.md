# sanOS — A web-based agentic AI OS, made with Cursor
...
- System-wide San AI, with tool calls and context of running applications
...
- **Chats**: AI-powered chat with speech & tool calling
  - Natural conversation with San AI
  - Join public chat rooms with @san mentions
  ...
  - sanOS FM DJ mode - when music plays, San becomes a radio DJ
...
- **Terminal**: Unix-like CLI with built-in AI
  ...
  - "san <prompt>" to chat with AI assistant
...
This project is a fork of [ryOS](https://github.com/ryokun6/ryos) by Ryo Lu, originally created under the AGPL-3.0 license. The original ryOS is an incredible web-based agentic AI OS that inspired this sanOS fork.
